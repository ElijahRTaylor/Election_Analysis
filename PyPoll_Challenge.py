...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_name not in voter_counties:
             
            # 4b: Add the existing county to the list of counties.
            voter_counties.append(county_name)
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_vote_breakdown=(f"{county_name}: {county_vote_percentage:.1f}%  {county_vote_count:,}\n")
        print(county_vote_breakdown)
         
         # 6e: Save the county votes to a text file.
        txt_file.write(county_vote_breakdown)
